...
export type Entry = { year: string; en: string; fr: string; place: string; placeFr?: string; photos?: string[] };
...
export const exhibitions: Entry[] = [
  ...
  {
    year: "2019",
    en: "Solo Exhibition at Studio Arteboul",
    fr: "Exposition Solo à Studio Arteboul",
    place: "Montréal, Canada",
  },
  {
    year: "2016",
