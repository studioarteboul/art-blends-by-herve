...
Private lessons and coaching for 25 years for students and artists of all levels.`;
...
Cours privés et coaching depuis 25 ans pour étudiants et artistes de tous niveaux.`;
